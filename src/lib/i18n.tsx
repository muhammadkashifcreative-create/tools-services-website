...
const en: Dict = {
  "nav.home": "Home",
  "nav.services": "Social Media Services",
  ...
  "footer.tagline": "Premium social growth solutions for creators, brands, and businesses worldwide.",
};

const dicts: Record<LangCode, Dict> = {
  en,
  es: {
    "nav.home": "Inicio", "nav.services": "Servicios", "nav.tools": "Herramientas", "nav.blog": "Blog", "nav.platforms": "Plataformas",
    ...
    "footer.tagline": "Soluciones premium de crecimiento social para creadores, marcas y empresas de todo el mundo.",
  },
  fr: {
    "nav.home": "Accueil", "nav.services": "Services", "nav.tools": "Outils", "nav.blog": "Blog", "nav.platforms": "Plateformes",
    ...
    "footer.tagline": "Solutions premium de croissance sociale pour créateurs, marques et entreprises du monde entier.",
  },
  de: {
    "nav.home": "Start", "nav.services": "Dienste", "nav.tools": "Tools", "nav.blog": "Blog", "nav.platforms": "Plattformen",
    ...
    "footer.tagline": "Premium-Lösungen für soziales Wachstum für Creators, Marken und Unternehmen weltweit.",
  },
  it: {
    "nav.home": "Home", "nav.services": "Servizi", "nav.tools": "Strumenti", "nav.blog": "Blog", "nav.platforms": "Piattaforme",
    ...
    "footer.tagline": "Soluzioni premium di crescita sociale per creator, brand e aziende in tutto il mondo.",
  },
  pt: {
    "nav.home": "Início", "nav.services": "Serviços", "nav.tools": "Ferramentas", "nav.blog": "Blog", "nav.platforms": "Plataformas",
    ...
    "language.label": "Idioma",
    "footer.tagline": "Soluções premium de crescimento social para criadores, marcas e empresas em todo o mundo.",
  },
  ru: {
    "nav.home": "Главная", "nav.services": "Услуги", "nav.tools": "Инструменты", "nav.blog": "Блог", "nav.platforms": "Платформы",
    ...
    "language.label": "Язык",
    "footer.tagline": "Премиум-решения для роста в социальных сетях для создателей, брендов и бизнеса по всему миру.",
  },
  zh: {
    "nav.home": "首页", "nav.services": "服务", "nav.tools": "工具", "nav.blog": "博客", "nav.platforms": "平台",
    ...
    "language.label": "语言",
    "footer.tagline": "为全球创作者、品牌和企业提供优质的社交增长解决方案。",
  },
  ja: {
    "nav.home": "ホーム", "nav.services": "サービス", "nav.tools": "ツール", "nav.blog": "ブログ", "nav.platforms": "プラットフォーム",
    ...
    "language.label": "言語",
    "footer.tagline": "世界中のクリエイター、ブランド、企業のためのプレミアムソーシャル成長ソリューション。",
  },
  hi: {
    "nav.home": "होम", "nav.services": "सेवाएं", "nav.tools": "टूल्स", "nav.blog": "ब्लॉग", "nav.platforms": "प्लेटफ़ॉर्म",
    ...
    "language.label": "भाषा",
    "footer.tagline": "दुनिया भर के निर्माताओं, ब्रांडों और व्यवसायों के लिए प्रीमियम सोशल ग्रोथ सॉल्यूशंस।",
  },
  id: {
    "nav.home": "Beranda", "nav.services": "Layanan", "nav.tools": "Alat", "nav.blog": "Blog", "nav.platforms": "Platform",
    ...
    "footer.tagline": "Solusi pertumbuhan sosial premium untuk kreator, merek, dan bisnis di seluruh dunia.",
  },
  ms: {
    "nav.home": "Utama", "nav.services": "Perkhidmatan", "nav.tools": "Alatan", "nav.blog": "Blog", "nav.platforms": "Platform",
    ...
    "language.label": "Bahasa",
    "footer.tagline": "Penyelesaian pertumbuhan sosial premium untuk pencipta, jenama, dan perniagaan di seluruh dunia.",
  },
  tr: {
    "nav.home": "Ana sayfa", "nav.services": "Hizmetler", "nav.tools": "Araçlar", "nav.blog": "Blog", "nav.platforms": "Platformlar",
    ...
    "language.label": "Dil",
    "footer.tagline": "Dünya çapında içerik üreticileri, markalar ve işletmeler için premium sosyal büyüme çözümleri.",
  },
  ar: {
    "nav.home": "الرئيسية", "nav.services": "الخدمات", "nav.tools": "الأدوات", "nav.blog": "المدونة", "nav.platforms": "المنصات",
    ...
    "footer.tagline": "حلول متميزة للنمو الاجتماعي للمبدعين والعلامات التجارية والشركات في جميع أنحاء العالم.",
  },
};
