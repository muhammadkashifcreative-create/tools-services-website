...
const en: Dict = {
  ...
  "footer.tagline": "Practical guide books for computer software — instant digital download, worldwide.",
};

const dicts: Record<LangCode, Dict> = {
  en,
  es: {
    "nav.home": "Inicio", "nav.books": "Libros guía", "nav.blog": "Blog", "nav.platforms": "Plataformas",
    ...
    "footer.tagline": "Libros guía prácticos de software informático — descarga digital instantánea en todo el mundo.",
  },
  fr: {
    "nav.home": "Accueil", "nav.books": "Guides", "nav.blog": "Blog", "nav.platforms": "Plateformes",
    ...
    "footer.tagline": "Guides pratiques pour logiciels informatiques — téléchargement numérique instantané, partout dans le monde.",
  },
  de: {
    "nav.home": "Start", "nav.books": "Handbücher", "nav.blog": "Blog", "nav.platforms": "Plattformen",
    ...
    "footer.tagline": "Praktische Handbücher für Computersoftware – sofortiger digitaler Download, weltweit.",
  },
  it: {
    "nav.home": "Home", "nav.books": "Guide", "nav.blog": "Blog", "nav.platforms": "Piattaforme",
    ...
    "footer.tagline": "Guide pratiche per software — download digitale istantaneo, in tutto il mondo.",
  },
  pt: {
    "nav.home": "Início", "nav.books": "Guias", "nav.blog": "Blog", "nav.platforms": "Plataformas",
    ...
    "language.label": "Idioma",
    "footer.tagline": "Guias práticos de software — download digital instantâneo, em todo o mundo.",
  },
  ru: {
    "nav.home": "Главная", "nav.books": "Книги-гиды", "nav.blog": "Блог", "nav.platforms": "Платформы",
    ...
    "language.label": "Язык",
    "footer.tagline": "Практичные книги-гиды по программам — мгновенная цифровая загрузка по всему миру.",
  },
  zh: {
    "nav.home": "首页", "nav.books": "指南书", "nav.blog": "博客", "nav.platforms": "平台",
    ...
    "language.label": "语言",
    "footer.tagline": "实用的电脑软件指南书 — 全球即时数字下载。",
  },
  ja: {
    "nav.home": "ホーム", "nav.books": "ガイドブック", "nav.blog": "ブログ", "nav.platforms": "プラットフォーム",
    ...
    "language.label": "言語",
    "footer.tagline": "実践的なソフトウェアガイドブック — 世界中どこでも即時デジタルダウンロード。",
  },
  hi: {
    "nav.home": "होम", "nav.books": "गाइड बुक्स", "nav.blog": "ब्लॉग", "nav.platforms": "प्लेटफ़ॉर्म",
    ...
    "language.label": "भाषा",
    "footer.tagline": "कंप्यूटर सॉफ़्टवेयर के लिए व्यावहारिक गाइड बुक्स — दुनिया भर में तुरंत डिजिटल डाउनलोड।",
  },
  id: {
    "nav.home": "Beranda", "nav.books": "Buku Panduan", "nav.blog": "Blog", "nav.platforms": "Platform",
    ...
    "footer.tagline": "Buku panduan praktis untuk perangkat lunak komputer — unduhan digital instan, ke seluruh dunia.",
  },
  ms: {
    "nav.home": "Utama", "nav.books": "Buku Panduan", "nav.blog": "Blog", "nav.platforms": "Platform",
    ...
    "language.label": "Bahasa",
    "footer.tagline": "Buku panduan praktikal untuk perisian komputer — muat turun digital serta-merta, ke seluruh dunia.",
  },
  tr: {
    "nav.home": "Ana sayfa", "nav.books": "Rehber Kitaplar", "nav.blog": "Blog", "nav.platforms": "Platformlar",
    ...
    "language.label": "Dil",
    "footer.tagline": "Bilgisayar yazılımları için pratik rehber kitaplar — dünya çapında anında dijital indirme.",
  },
  ar: {
    "nav.home": "الرئيسية", "nav.books": "كتب إرشادية", "nav.blog": "المدونة", "nav.platforms": "المنصات",
    ...
    "footer.tagline": "كتب إرشادية عملية لبرامج الكمبيوتر — تنزيل رقمي فوري في جميع أنحاء العالم.",
  },
};
