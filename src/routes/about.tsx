...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About — iGroBrand" },
      { name: "description", content: "iGroBrand helps creators and brands grow on every major social platform — fast, reliable, transparent." },
      { property: "og:title", content: "About — iGroBrand" },
      { property: "og:description", content: "Our mission, story, and the team behind iGroBrand." },
    ],
  }),
  component: AboutPage,
});
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
        <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">About iGroBrand</h1>
        <p className="mt-4 text-lg text-muted-foreground">
          iGroBrand is a social growth engine for creators, agencies, and brands.
